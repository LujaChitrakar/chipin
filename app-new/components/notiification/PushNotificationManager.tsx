...
import { storeExpoNotificationToken } from '@/services/api/notificationApi';
...
const PushNotificationManager: React.FC<PropsWithChildren<{}>> = ({
    ...
    const { user } = usePrivy(); // "ready" tells when Privy has finished initializing
    ...
    useEffect(() => {
        ...
        registerForPushNotificationsAsync().then((token) => {
            if (token) {
                storeExpoNotificationToken(token,)
