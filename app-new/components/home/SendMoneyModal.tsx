...
const SendMoneyModal = ({
  ...
  console.log('FRIENDS DATA::', JSON.stringify(friendsData, null, 2));
        ...
        >
            ...
            >
              {selectedFriend ? (
                ...
                <>
                  ...
                  >
                    Scan the QR Above to Send Money
                  </Text>
                </>
              )}
            </View>
          ...
          >
            <TouchableOpacity
              ...
              disabled={!selectedFriend || !amount || !purpose || sendingMoney}
              onPress={handleSend}
            >
              {sendingMoney ? (
                // <View>
