...
import { Chipin } from "../target/types/chipin";
...
describe("chipin", () => {
  ...
  const program = anchor.workspace.Multisig as Program<Chipin>;
  ...
  const getGatewayAddress = (program: Program<Chipin>) => {
